# Native OpenCode Package

OpenCode project agents can be represented as `.opencode/agents/*.md` files.
This package provides `standard` and `advanced` agent profiles; the default
OpenCode session is `primary`.
